classdef nanog_gata6_6_model < models.model
    %% Gata6 inhibits FGF4 production
    methods
        function obj = nanog_gata6_6_model(varargin)
        ...
        function initialize(obj)
            ...
            obj.tmax = 50;
            obj.par = struct(...
                ...%'alfa3',0.4,'alfa1',2.4,'alfa2',3.0,'alfa6',2.0,...
                'alfa3',0.5,'alfa1',2.5,'alfa2',3.0,'alfa6',3.0,...
                'beta',2,'gamma',2,'delta',2,'eta',2,...
                'k_deg',1,'lambda',50,'Fext',0);
        end
        ...
        function [J, stable] = jacobian(obj, steady_state)
            ...
            dh_dG = -obj.par.alfa6.*obj.par.delta.*(gata6.^(obj.par.delta-1))./((1+gata6.^obj.par.delta).^2);
            dh_dN = 0;
            dh_dFGF = -1;
        ...
        function y = quasy_steady_state(obj, fgf)
            ...
            gata6 = (obj.par.alfa6./fgf -1).^(1./obj.par.delta);
            nanog = (obj.par.alfa2./gata6 -1).^(1./obj.par.gamma);
        ...
        function [dydt] = df_model(obj, t, y, s_ext_supp, s_inh)
            ...
            fgf4_per = obj.neigh.neigh_avg(fgf4)+s_ext_supp;
            ...
            d_fgf4 = (1-s_inh).*obj.par.alfa6.*1./(1+gata6.^obj.par.delta) -obj.par.k_deg.*fgf4;
